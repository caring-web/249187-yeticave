...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <a class="main-header__logo" href="<?= !$is_home_page ? 'index.php' : ''; ?>">
        ...
        <nav class="user-menu">
            <?php if (!empty($user)): ?>
                    <div class="user-menu__image">
                        <img src="<?=empty($user['avatar']) ? 'img/user.png' : "img/" . $user['avatar']; ?>" width="40" height="40" alt="Аватар пользователя">
                    </div>
...
<main class=<?= $is_home_page ? 'container' : ''; ?>>
    <?php if (!$is_home_page && isset($categories_content) ): ?>
        <?= $categories_content; ?>
    <?php endif; ?>
    <?=$content; ?>
</main>
